              ...
              {activeTab === 'goals' && (
                  <div className="h-full flex flex-col gap-6 animate-fade-in">
                      ...
                      <div className="flex-1 flex flex-col">
                          ...
                          <textarea 
                              className="flex-1 w-full p-4 border-2 border-ink font-mono text-sm resize-none focus:outline-none focus:border-accent"
                              value={tempGoals}
                             ...
                             {isEditing ? (
                                <div className="space-y-4 flex-1">
                                   ...
                                   <div>
                                      ...
                                      <select 
                                         className="w-full p-2 border-2 border-ink text-sm font-mono outline-none"
                                         value={editCategory}
